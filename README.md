...
- **User stories**: [`USER_STORIES.md`](./USER_STORIES.md) — covers publishing properties/listings, searching as a visitor, applying/withdrawing, shortlisting/visits/acceptance, reviews, saving/reporting listings, and moderation, from the visitor, member, and moderator perspectives.
- **Domain model**: [`domain-model.dbml`](./domain-model.dbml) (source) and [`domain-model.png`](./domain-model.png) (diagram). Open the `.dbml` file's contents in [dbdiagram.io](https://dbdiagram.io) to view or edit it interactively.
- **Design decisions**: [`design-decisions.md`](./design-decisions.md) — explains entities added beyond the project description, the lifecycle of listings and applications, and modeling assumptions.
